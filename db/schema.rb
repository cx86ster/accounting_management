...
ActiveRecord::Schema.define(version: 20171209154034) do

  create_table "accounting_classes", force: :cascade do |t|
    t.string   "accounting_class_code", limit: 255, null: false
    t.string   "accounting_class_name", limit: 255
  ...
  create_table "accounting_sources", force: :cascade do |t|
    t.string   "accounting_source_code", limit: 255, null: false
    t.string   "accounting_source_name", limit: 255
    t.datetime "deleted_at"
    t.datetime "created_at",                         null: false
    t.datetime "updated_at",                         null: false
  end
  ...
  create_table "accountings", force: :cascade do |t|
    ...
    t.datetime "created_at",                       null: false
    t.datetime "updated_at",                       null: false
    t.integer  "accounting_class_id",  limit: 4
    t.integer  "accounting_source_id", limit: 4
  end
